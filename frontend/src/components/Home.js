...
//           "http://localhost:9004/api/metrics/donations"
//         );

//         // Fetch requests without auth headers
//         const requestsRes = await axios.get(
//           "http://localhost:9004/api/metrics/requests"
//         );

//         // Fetch users without auth headers
//         const usersRes = await axios.get(
//           "http://localhost:9004/api/metrics/users"
//         );
  ...
  const fetchData = async () => {
    try {
      const [donationsRes, requestsRes, usersRes] = await Promise.all([
        axios.get("http://localhost:9004/api/metrics/donations"),
        axios.get("http://localhost:9004/api/metrics/requests"),
        axios.get("http://localhost:9004/api/metrics/users"),
      ]);
